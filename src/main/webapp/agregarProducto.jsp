...
<body class="color-fondo text-black">
	...
	<header class="border-b border-color-borde">
		<nav
			...
			<div class="flex items-center space-x-4 text-black text-sm">
				<ul
					class="hidden md:flex space-x-6 text-sm font-gv color-text">
					<%
	...
	<h2 class="text-4xl font-bold font-gv color-text mb-4">Agragar Producto</h2>
    ...
    <table class="table-auto">
        <tr>
            <td>
                <label class="text-4xl font-gv color-text mb-4" for="nombre">Producto:</label>
            </td>
            <td>
                <input class="text-2xl font-gv" type="text" id="nombre" name="nombre" required>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <label class="text-4xl font-gv color-text mb-4" for="cantidad">Cantidad:</label>
            </td>
            <td>
                <input class="text-2xl font-gv" type="number" id="cantidad" name="cantidad" required>
            </td>
        </tr>
        <tr>
            <td>
                <label class="text-4xl font-gv color-text mb-4" for="precio">Precio:</label>
            </td>
            <td>
                <input class="text-2xl font-gv" type="number" id="precio" name="precio" step="0.01" required>
            </td>
        </tr>
        <tr>
            <td colspan="2" class="text-center pt-4">
                <input type="submit" value="Agregar producto" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded font-normal text-2xl">
            </td>
        </tr>
    </table>
</form>
